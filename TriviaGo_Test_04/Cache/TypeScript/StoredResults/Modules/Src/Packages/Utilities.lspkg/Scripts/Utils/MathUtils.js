...
class MathUtils {
     ...
     */
    static quaternionToRoll(quaternion) {
     ...
     */
    static quaternionToPitch(quaternion) {
    ...
    static quaternionToEuler(quaternion) {
        ...
        return new vec3(pitch < 0 ? pitch + Math.PI * 2 : pitch, yaw < 0 ? yaw + Math.PI * 2 : yaw, roll < 0 ? roll + Math.PI * 2 : roll);
    }
    /**
     ...
     */
    static interpolateRotation(startRotation, endRotation, peakVelocity) {
     ...
     */
    static haversineDistance(location1, location2) {
