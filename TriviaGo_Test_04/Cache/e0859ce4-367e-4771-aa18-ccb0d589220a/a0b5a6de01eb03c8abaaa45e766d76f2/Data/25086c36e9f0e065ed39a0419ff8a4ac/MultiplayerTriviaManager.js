...
let MultiplayerTriviaManager = (() => {
    ...
    var MultiplayerTriviaManager = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.hostSyncEntity = null;
            this.guestSyncEntity = null;
        ...
        onSessionReady() {
            ...
            const globalId = { customNetworkId: 'triviaGlobalChannel', networkIdType: 'Custom' };
            ...
            const hostEntityId = { customNetworkId: 'triviaHostChannel', networkIdType: 'Custom' };
            this.hostSyncEntity = new SyncEntity_1.SyncEntity(this, new StoragePropertySet_1.StoragePropertySet([this.hostScoreProp, this.hostReadyProp]), this.isHost, 'Session', hostEntityId);
            // 3. Guest Channel Setup (Guest/Player owns write permissions, host reads)
            const guestEntityId = { customNetworkId: 'triviaGuestChannel', networkIdType: 'Custom' };
            this.guestSyncEntity = new SyncEntity_1.SyncEntity(this, new StoragePropertySet_1.StoragePropertySet([this.guestScoreProp, this.guestReadyProp]), !this.isHost, 'Session', guestEntityId);
