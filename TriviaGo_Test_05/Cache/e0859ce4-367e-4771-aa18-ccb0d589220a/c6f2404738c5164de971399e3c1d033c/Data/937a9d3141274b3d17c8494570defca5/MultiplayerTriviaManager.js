    ...
    var MultiplayerTriviaManager = _classThis = class extends _classSuper {
        ...
        onSessionReady() {
            ...
            this.gameSyncEntity.notifyOnReady(() => {
                ...
                const hostStoreId = { customNetworkId: 'trivia_host_store', networkIdType: 'Custom' };
                const guestStoreId = { customNetworkId: 'trivia_guest_store', networkIdType: 'Custom' };
                this.hostPlayerSyncEntity = new SyncEntity_1.SyncEntity(this, new StoragePropertySet_1.StoragePropertySet([this.hostScoreProp, this.hostReadyProp]), this.isHost, // Only the true Host writes to this entity
                'Session', hostStoreId);
                this.guestPlayerSyncEntity = new SyncEntity_1.SyncEntity(this, new StoragePropertySet_1.StoragePropertySet([this.guestScoreProp, this.guestReadyProp]), !this.isHost, // The non-host guest writes to this entity
        ...
        // ───────────────────────────────────────────────────────────────────────────
        setupScoreboardCrossTalkListeners() {
            ...
            this.hostScoreProp.onAnyChange.add(() => {
                ...
                if (this.isHost) {
                    if (this.myScoreValueText)
                        this.myScoreValueText.text = String(val);
                }
                else {
                    if (this.opponentScoreValueText)
