...
Output_N1=param_1;
float Rim_N0=0.0;
float3 param_2=(*sc_set0.UserUniforms).Port_Normal_N000;
float param_3=(*sc_set0.UserUniforms).Port_Exponent_N000;
...
float4 l9_5=fast::max(param_8,float4(0.0));
float4 param_9=l9_5;
if (sc_ShaderCacheConstant_tmp!=0)
{
