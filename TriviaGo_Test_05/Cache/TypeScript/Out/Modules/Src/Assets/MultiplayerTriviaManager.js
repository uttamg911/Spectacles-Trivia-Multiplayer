    ...
    var MultiplayerTriviaManager = _classThis = class extends _classSuper {
        ...
        onSessionReady() {
            ...
            if (this.roastFetcherComponent && this.roastText) {
                this.roastFetcher.onRoastReceived = (text) => {
            ...
            sc.onMessageReceived.add((_session, _userId, message, _senderInfo) => this.onMessageReceived(message));
            if (this.isHost) {
