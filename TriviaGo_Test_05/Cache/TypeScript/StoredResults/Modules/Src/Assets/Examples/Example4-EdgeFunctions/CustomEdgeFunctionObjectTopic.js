...
var __selfType = requireType("./CustomEdgeFunctionObjectTopic");
...
let EdgeFunctionImgProcessing = (() => {
    ...
    var EdgeFunctionImgProcessing = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.functionName = this.functionName; // e.g. random-trivia
            // ✅ NEW: object filter
                        ...
                        try {
                            ...
                            if (result.ok === true) {
                                ...
                                if (result.object !== undefined)
                                    this.log(`object returned: ${result.object}`);
                                if (result.topic !== undefined)
                                    this.log(`topic returned: ${result.topic}`);
                                if (result.record) {
                                    ...
                                    if (result.record.answer !== undefined)
                                        this.log(`answer: ${result.record.answer}`);
                                }
                                else {
        ...
        callFunctionWithFilters(objectValue, topicValue) {
...
//# sourceMappingURL=CustomEdgeFunctionObjectTopic.js.map