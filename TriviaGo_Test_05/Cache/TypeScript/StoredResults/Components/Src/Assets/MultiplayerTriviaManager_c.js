...
// @input Component.ScriptComponent roastFetcherComponent {"hint":"EdgeFunctionRoastById script component"}
// @input Component.Text roastText {"hint":"Text component to display the roast message on screen"}
...
var Module = require("../../../Modules/Src/Assets/MultiplayerTriviaManager");
...
awakeEvent.bind(() => {
    ...
    checkUndefined("roastFetcherComponent", []);
    checkUndefined("roastText", []);
    if (script.onAwake) {
       script.onAwake();
    }
});
