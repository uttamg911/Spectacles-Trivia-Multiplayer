...
export class CustomEdgeFunctionObjectTopicUI extends BaseScriptComponent {
  ...
  onAwake() {
    ...
    this.setupOptionButtonOne()
    this.setupOptionButtonTwo()
    this.setupOptionButtonThree()
    this.setupOptionButtonFour()
  ...
  private setupOptionButtonThree() {
