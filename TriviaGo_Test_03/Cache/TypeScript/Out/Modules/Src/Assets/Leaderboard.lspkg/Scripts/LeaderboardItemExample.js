...
exports.LeaderboardItemExample = void 0;
var __selfType = requireType("./LeaderboardItemExample");
...
let LeaderboardItemExample = (() => {
    let _classDecorators = [component];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = BaseScriptComponent;
    var LeaderboardItemExample = _classThis = class extends _classSuper {
        constructor() {
            super();
            /**
             ...
             */
            this.positionText = this.positionText;
            /**
             ...
             */
            this.highlightTestData = this.highlightTestData;
            /**
        ...
        onAwake() {
            // Initialize logger
            this.logger = new Logger_1.Logger("LeaderboardItemExample", this.enableLogging || this.enableLoggingLifecycle, true);
         ...
         */
        findTextComponentByNameAlternatives(baseName) {
         ...
         */
        updateAnyRemainingTextComponent(fieldType, value) {
         ...
         */
        tryFindAndUpdateTextWithAlternatives(baseChildName, textValue) {
         ...
         * @param textValue Text value to set
         */
        tryFindAndUpdateText(childName, textValue) {
            for (let i = 0; i < this.getSceneObject().getChildrenCount(); i++) {
                const child = this.getSceneObject().getChild(i);
         ...
         */
        applyColorToAllTextComponentsRecursively(obj, color) {
    ...
    __setFunctionName(_classThis, "LeaderboardItemExample");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        LeaderboardItemExample = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return LeaderboardItemExample = _classThis;
})();
exports.LeaderboardItemExample = LeaderboardItemExample;
//# sourceMappingURL=LeaderboardItemExample.js.map