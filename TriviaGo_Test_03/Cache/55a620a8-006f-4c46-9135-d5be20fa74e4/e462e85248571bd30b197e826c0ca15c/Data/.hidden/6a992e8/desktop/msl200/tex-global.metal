...
//float Port_Input2_N043 6420
//float Port_Input2_N062 6424
...
float4 l9_1845=fast::max(param_5,float4(0.0));
float4 param_6=l9_1845;
if (sc_ShaderCacheConstant_tmp!=0)
{
