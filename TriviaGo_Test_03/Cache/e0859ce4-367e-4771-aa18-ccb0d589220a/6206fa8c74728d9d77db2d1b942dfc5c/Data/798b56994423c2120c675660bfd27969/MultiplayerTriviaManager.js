...
let MultiplayerTriviaManager = (() => {
    ...
    var MultiplayerTriviaManager = _classThis = class extends _classSuper {
        ...
        onSessionReady() {
            ...
            this.hostBuzzerEntity = new SyncEntity_1.SyncEntity(this, new StoragePropertySet_1.StoragePropertySet([this.hostBuzzedTimeProp]), true, // TRUE if this is host device, FALSE if guest device
            ...
            this.guestBuzzerEntity = new SyncEntity_1.SyncEntity(this, new StoragePropertySet_1.StoragePropertySet([this.guestBuzzedTimeProp]), true, // TRUE if this is guest device, FALSE if host device
