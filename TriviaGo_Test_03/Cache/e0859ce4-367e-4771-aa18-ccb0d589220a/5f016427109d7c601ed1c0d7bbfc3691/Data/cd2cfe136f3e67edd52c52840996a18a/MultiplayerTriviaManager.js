...
let MultiplayerTriviaManager = (() => {
    ...
    var MultiplayerTriviaManager = _classThis = class extends _classSuper {
        ...
        onSessionReady() {
            ...
            this.gameSyncEntity = new SyncEntity_1.SyncEntity(this, new StoragePropertySet_1.StoragePropertySet([]), true, 'Session', gameNetworkId);
            ...
            // FIXED: Correctly matching the expected NetworkMessage structure argument
            this.gameSyncEntity.onEventReceived.add('syncFullQuestion', (message) => {
