...
let MultiplayerTriviaManager = (() => {
    ...
    var MultiplayerTriviaManager = _classThis = class extends _classSuper {
        constructor() {
            ...
            // ── SyncEntities ─────────────────────────────────────────────────────────
            this.gameSyncEntity = null; // host-owned
            this.hostPlayerEntity = null; // host-owned, host writes
            this.guestPlayerEntity = null; // guest-owned, guest writes
        ...
        onSessionReady() {
            ...
            this.hostPlayerEntity = new SyncEntity_1.SyncEntity(this, new StoragePropertySet_1.StoragePropertySet([this.hostReadyProp, this.hostBuzzedTimeProp]), this.isHost, 'Session', hostNetworkId);
            const guestNetworkId = { customNetworkId: 'triviaGuestPlayer', networkIdType: 'Custom' };
            this.guestPlayerEntity = new SyncEntity_1.SyncEntity(this, new StoragePropertySet_1.StoragePropertySet([this.guestReadyProp, this.guestBuzzedTimeProp]), !this.isHost, 'Session', guestNetworkId);
