...
let MultiplayerTriviaManager = (() => {
    ...
    var MultiplayerTriviaManager = _classThis = class extends _classSuper {
        ...
        hookOpponentStore(opponentId) {
            ...
            this.opponentPlayerSyncEntity = new SyncEntity_1.SyncEntity(this, new StoragePropertySet_1.StoragePropertySet([this.opponentScorePropRef, this.opponentReadyPropRef]), false, 'Session', opponentStoreId);
